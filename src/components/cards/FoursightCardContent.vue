<template>
  ...
  >
    ...
    />
    <img src="@/assets/svg/foursight-wordmark.svg" class="pointer-events-none z-10 h-8" />
    <img src="@/assets/images/app.webp" class="pointer-events-none z-10 rounded-lg shadow-xl" />
  </div>
</template>
