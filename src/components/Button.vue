...
const urls = {
  'arrow-left': new URL('@/assets/duotone/arrow-left.svg', import.meta.url).toString(),
  'arrow-right': new URL('@/assets/duotone/arrow-right.svg', import.meta.url).toString(),
}
</script>
...
.button {
  ...
  background:
    ...
    linear-gradient(0deg, rgba(37, 99, 235, 0.2) 0%, rgba(37, 99, 235, 0.2) 100%), #000;
}
.button:hover {
  @apply border-white/35 shadow-lg;
  background:
    linear-gradient(180deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0) 100%),
    linear-gradient(0deg, rgba(37, 99, 235, 0.33) 0%, rgba(37, 99, 235, 0.33) 100%), #000;
}
.button:active {
  @apply border-white/10 shadow-none;
  background: linear-gradient(0deg, rgba(37, 99, 235, 0.2) 0%, rgba(37, 99, 235, 0.2) 100%), #000;
}
</style>
