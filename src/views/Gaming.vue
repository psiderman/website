<template>
  ...
  <p class="-mt-8">
    <span class="mr-2 inline-flex h-6 w-6 items-center justify-center rounded-full bg-white/20 p-2">
      i </span
    >Update: My brother has my PC now. Lately, it's only the PS5 for me.
  </p>
  <p>
    I built my PC back in 2014, and its due for an upgrade any minute now. It's kept me company from
    the likes of Batman: Arkham Asylum, Splinter Cell: Blacklist, and although sluggishly, even up
    to Hitman 3 and Watch Dogs 2. For games after 2022, I have my PS5.
  </p>
  <div class="grid grid-cols-6 grid-rows-1 gap-4">
    ...
    />
    <div class="col-span-1 hidden grid-cols-1 grid-rows-5 content-start gap-4 lg:grid">
      <img
  ...
  <p class="caption">My best estimate of total hours played in life: 13,000h+</p>
  ...
  <p>
    I always wanted to create some sort of a gameplay montage, and had been recording these for a
    while. Had some time today so I fired up iMovie and picked a song from my recents in Spotify.
  </p>
  ...
  <div class="grid grid-cols-3 gap-4 sm:grid-cols-3">
    <div
      ...
      :key="i"
      :class="['anime-entry group/image relative aspect-square overflow-hidden rounded-lg']"
    >
      <img
        v-lazy="game.url"
...
const games = ref([
  {
    caption: 'I always recommend Life is Strange to someone who wants to start out with games.',
  ...
  },
  {
    ...
    url: new URL('@/assets/images/gaming/hitman3.jpg', import.meta.url).toString(),
  },
  {
    caption:
    ...
    url: new URL('@/assets/images/gaming/spiderman.jpg', import.meta.url).toString(),
  },
  {
    caption: 'This defined summer vacations for my brother and I.',
    url: new URL('@/assets/images/gaming/budokai.jpg', import.meta.url).toString(),
  },
  {
    caption:
    ...
    url: new URL('@/assets/images/gaming/arkham.jpg', import.meta.url).toString(),
  },
  {
    caption: "It's the one game that I'm not great at, but I love playing. There's always the one.",
